...
export const PrescriptionUploadModal: React.FC<PrescriptionUploadModalProps> = ({
  ...
  return (
    <div 
      className="fixed inset-0 z-50 overflow-y-auto bg-[#1C2B3A]/70 flex items-center justify-center p-3 sm:p-5"
    ...
    >
      ...
      >
        ...
        >
          ...
          {step === 'review' && (
            <div className="space-y-5">
              ...
              <div className="bg-[#FAF8F3] border border-[#DDD9D1] rounded-sm px-3.5 py-2.5 flex flex-wrap items-center justify-between gap-3 text-xs">
                <div className="flex items-center gap-2">
                  <span className="text-[#6B7A8D] font-medium">Patient:</span>
                  <span className="font-semibold text-[#1C2B3A]">
                    {clearScriptResult?.patientName || 'Subrata Mondal (58 M)'}
                  </span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="grid md:grid-cols-12 gap-5 items-start">
                ...
                <div className="md:col-span-5 bg-[#FAF8F3] border border-[#DDD9D1] rounded-sm p-4 space-y-3">
                  ...
                  {viewMode === 'ocr_text' ? (
                    <div className="bg-white border border-[#DDD9D1] rounded-sm p-3 font-mono text-[11px] text-[#1C2B3A] max-h-60 overflow-y-auto whitespace-pre-wrap space-y-1 shadow-xs">
                    ...
                    <div className="bg-white border border-[#DDD9D1] rounded-sm p-2 text-center space-y-2">
                      <img 
                        ...
                        className="max-h-52 w-full object-contain rounded-xs border border-[#DDD9D1]"
                      />
                  ...
                  <div className="p-2.5 bg-[#FAF8F3] border border-[#DDD9D1] rounded-sm text-[11px] text-[#6B7A8D] space-y-1">
                    <div className="flex items-center justify-between text-[10px] font-mono text-[#1C2B3A]">
                      <span>Engine: ClearScript.js v2.6 (Tesseract Wasm)</span>
                ...
                <div className="md:col-span-7 space-y-3">
                  ...
                  {allExtractedMeds.length > 1 && (
                    <div className="space-y-1.5 bg-[#FAF8F3] p-2.5 rounded-sm border border-[#DDD9D1]">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[10px] text-[#6B7A8D]">
                          Click tabs to inspect/edit each medication
                        </span>
                      </div>
                      <div className="flex flex-wrap gap-2 pt-1">
                        {allExtractedMeds.map((med, idx) => (
                          <button
                            ...
                            className={`px-3 py-1.5 text-xs rounded-sm border font-semibold flex items-center gap-2 transition-all ${
        ...
        {step === 'review' && (
          <div className="shrink-0 border-t border-[#DDD9D1] bg-[#FAF8F3] px-5 sm:px-6 py-3.5 flex flex-wrap items-center justify-between gap-3 shadow-inner">
            <button
              type="button"
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <button
                type="button"
                onClick={onClose}
                className="border border-[#DDD9D1] bg-white text-[#1C2B3A] font-semibold text-xs px-3.5 py-2 rounded-sm hover:bg-[#FAF8F3] transition-colors"
              >
                Discard
              </button>
              ...
              {allExtractedMeds.length > 1 ? (
                <>
                  <button
                    ...
                    className="border border-[#3D8B6E] text-[#2D5A40] bg-[#EBF5EC] font-semibold text-xs px-3 py-2 rounded-sm hover:bg-[#D3EAD7] transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="bg-[#3D8B6E] text-white font-semibold text-xs px-4 py-2 rounded-sm hover:bg-[#2D5A40] transition-colors flex items-center gap-1.5 shadow-sm"
                  >
