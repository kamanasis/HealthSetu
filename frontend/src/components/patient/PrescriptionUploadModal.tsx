...
export const PrescriptionUploadModal: React.FC<PrescriptionUploadModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#1C2B3A]/70">
      <div className="bg-white rounded-sm border border-[#DDD9D1] max-w-4xl w-full p-6 sm:p-8 space-y-5 max-h-[92vh] overflow-y-auto">
        ...
        {step === 'review' && (
          <div className="space-y-5">
            ...
            {/* Modal Actions */}
            <div className="pt-4 border-t border-[#DDD9D1] flex flex-wrap items-center justify-between gap-3">
              <button
                type="button"
