      ...
      <div className="max-w-6xl mx-auto px-6 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl text-[#1C2B3A]">
            <TextReveal text="One platform. Three purpose-built experiences." stagger={0.02} yOffset={26} />
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          {/* Card 1: Patient */}
          <SectionReveal delay={0} yOffset={50}>
            <div className="bg-[#FAF8F3]/60 rounded-2xl border border-[#DDD9D1] p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between group h-full">
          ...
          {/* Card 2: Doctor */}
          <SectionReveal delay={0.15} yOffset={50}>
            <div className="bg-[#FAF8F3]/60 rounded-2xl border border-[#DDD9D1] p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between group h-full">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
          ...
          {/* Card 3: Hospital */}
          <SectionReveal delay={0.3} yOffset={50}>
            <div className="bg-[#FAF8F3]/60 rounded-2xl border border-[#DDD9D1] p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between group h-full">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
